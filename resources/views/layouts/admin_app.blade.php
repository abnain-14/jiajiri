    ...
    <header>
        <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-dark  fixed-top py-3">
            <div class="container-fluid ">
                <a class="navbar-brand text-light" href="/admin" style=""><strong>Jiajiri Admin</strong>
                </a>
        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-dark ">
            <div class="position-sticky ">
                <div class="list-group  list-group-flush mx-2 mt-4">
                    ...
                    <a href="/manage_freelancers"
                        class="list-group-item list-group-item-action py-3 bg-dark  ripple hoverable"
                        aria-current="true">
                        <i class="fas fa-blog text-light fa-fw me-3"></i><span class="text-light"> Manage Freelancers</span>
                    </a>

                    <a href="/manage_consultants"
                        class="list-group-item list-group-item-action py-3 bg-dark  ripple hoverable"
                        aria-current="true">
                        <i class="fas fa-user text-light fa-fw me-3"></i><span class="text-light"> Manage Consultants</span>
                    </a>

                      <a href="/manage_payments"
                        class="list-group-item list-group-item-action py-3 bg-dark  ripple hoverable"
                        aria-current="true">
                        <i class="fas fa-money text-light fa-fw me-3"></i><span class="text-light"> Manage Payments</span>
                    </a>
