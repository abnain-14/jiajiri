     ...
     @if (count($consultants) > 0)
         <section>
             ...
             <div class="row mx-auto">
                 <h5 class="mt-3 dark-grey-text font-weight-bold col-md-9 animated fadeIn">Manage Consultants</h5>
                     ...
                     <div class="modal-content">
                         ...
                         <div class="modal-header">
                             <h4 class="card-title h4 mb-3"><strong><a href="" class="grey-text">CREATE
                                         CONSULTANT</a></strong></h4>
                             <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                         </div>
                         <div class="modal-body">
                             <p>Please fill the fields below</p>
                             <div class="m-3">
                                 {!! Form::open(['action' => 'App\Http\Controllers\Admin\AdminConsultantsController@store', 'method' => 'POST']) !!}
                                 ...
                                 <div class=" m-auto">
                                     ...
                                     {{ Form::select('role', ['consultant' => 'consultant'], '', ['class' => 'mdb-select md-form']) }}
             ...
             <div class="card card-cascade narrower z-depth-1">
                 <div
                     ...
                     <a href="" class="white-text mx-3">Choose a consultant to edit</a>
                 </div>
                         ...
                         <table class="table table-hover mb-1 animated fadeIn">
                             ...
                             <tbody>
                                 @foreach ($consultants as $consultant)
                                     @php
                                         $attended = \App\Models\Applications::where('consultant_id', $consultant->id)->count();
                                         $job_reqs = \App\Models\JobRequest::where('user_id', $consultant->id)->count();
                                     @endphp
                                     <tr>
                                         ...
                                         <td>
                                             ...
                                             <a href="/manage_consultants/{{ $consultant->id }}"
                                                 class="btn btn-sm btn-primary mx-3">edit</a>

                                             <a href="#deleteUserModal{{ $consultant->id }}"
                                     ...
                                     <div id="deleteUserModal{{ $consultant->id }}" class="modal fade">
                                         <div class="modal-dialog">
                                             <div class="modal-content">

                                                 <div class="modal-header">
                                                     <h4 class="card-title h4 mb-3"><strong><a href=""
                                                                 class="grey-text">DELETE CONSULTANT</a></strong></h4>
                                                 ...
                                                 <div class="modal-footer">
                                                     ...
                                                     {!! Form::open([
                                                         'action' => ['App\Http\Controllers\Admin\AdminConsultantsController@destroy', $consultant->id],
                                                         'method' => 'POST',
                                                     ]) !!}
     ...
     @else
         <div class="dark-grey-text d-flex  align-items-center pt-3 pb-4 pl-4 ">
             <div class="mx-auto">
                 ...
                 <h4 class="m-4 ">No Consultants</h4>
